...
export const CHARACTER_CLASSES: CharacterClass[] = [
  ...
  { id: 'lich', name: 'Lich', description: 'Undead sorcerer. Can cast T2 spells while Drained.', icon: '💀', offense: 600, defense: 400, magic: 900, primaryStrength: 'Necromancy/Soulbinding', majorWeakness: 'Fire Vulnerability', category: 'high_magic', tier: 'exotic', maxMana: 180, maxStamina: 50, startingSkills: ['Necromancy', 'Soulbinding'], passive: 'Can cast T2 spells while Drained without entering Shaking stage', defaultStats: { necromancy: 25, soulbinding: 20, destruction: 15, alteration: 10, illusion: 5, intimidation: 10, brawling: 2, one_handed: 2, climbing: 2, infamy: 15 } },
  { id: 'werewolf', name: 'Werewolf', description: 'Primal beast. Uses Stamina for Primal Leap and Frenzy.', icon: '🐺', offense: 90, defense: 60, magic: 10, primaryStrength: 'Brawling/Regeneration', majorWeakness: 'Weak to Silver/Low Mana', category: 'low_magic', tier: 'exotic', maxMana: 15, maxStamina: 180, startingSkills: ['Brawling', 'Regeneration'], defaultStats: { brawling: 25, regeneration: 15, acrobatics: 15, climbing: 15, stealth: 10, intimidation: 10, beastmastery: 10, destruction: 1, alteration: 1, bravery: 10 } },
  { id: 'angel', name: 'Fallen Angel', description: 'Celestial being. High magic resistance, weak to Bloodmancy.', icon: '👼', offense: 80, defense: 30, magic: 90, primaryStrength: 'Alteration/Justice', majorWeakness: 'Double damage from Bloodmancy', category: 'high_magic', tier: 'exotic', maxMana: 200, maxStamina: 45, startingSkills: ['Alteration', 'Justice'], defaultStats: { alteration: 25, regeneration: 20, destruction: 15, persuasion: 10, justice: 20, honor: 15, mercy: 10, brawling: 2, stealth: 1 } },
  { id: 'vampire', name: 'Vampire Noble', description: 'Can bite to restore Stamina mid-battle.', icon: '🧛', offense: 80, defense: 50, magic: 60, primaryStrength: 'Seduction/Bloodmancy/Acrobatics', majorWeakness: 'Sunlight Weakness', category: 'hybrid', tier: 'exotic', maxMana: 70, maxStamina: 90, startingSkills: ['Seduction', 'Bloodmancy', 'Acrobatics'], defaultStats: { seduction: 25, bloodmancy: 20, acrobatics: 15, stealth: 12, persuasion: 10, intimidation: 8, one_handed: 8, infamy: 10, malice: 5 } },
  { id: 'abyssal-mutant', name: 'Abyssal Mutant', description: 'Warped by betrayal. Deception and raw power.', icon: '🧬', offense: 90, defense: 70, magic: 30, primaryStrength: 'Deception/Brawling', majorWeakness: 'NPCs distrust you', category: 'low_magic', tier: 'exotic', maxMana: 20, maxStamina: 170, startingSkills: ['Deception', 'Brawling'], defaultStats: { brawling: 25, intimidation: 20, climbing: 12, stealth: 10, two_handed: 8, acrobatics: 8, infamy: 20, malice: 10, destruction: 3 } },

  // === Professional/Normal Classes ===
  { id: 'inquisitor', name: 'Inquisitor', description: 'Gains Mana when using Intimidation on magical enemies.', icon: '⚖️', offense: 70, defense: 60, magic: 50, primaryStrength: 'Intimidation/One Handed', majorWeakness: 'Low flexibility', category: 'hybrid', tier: 'professional', maxMana: 65, maxStamina: 95, startingSkills: ['Intimidation', 'One Handed'], defaultStats: { intimidation: 20, one_handed: 18, investigation: 15, persuasion: 8, destruction: 8, alteration: 5, justice: 15, honor: 10, bravery: 8 } },
  { id: 'bounty-hunter', name: 'Bounty Hunter', description: 'Can Track betrayers with low Stamina cost.', icon: '🎯', offense: 70, defense: 50, magic: 30, primaryStrength: 'Beastmastery/Ranged', majorWeakness: 'Weak in close combat', category: 'low_magic', tier: 'professional', maxMana: 20, maxStamina: 160, startingSkills: ['Beastmastery', 'Ranged'], defaultStats: { aim: 22, beastmastery: 18, stealth: 12, investigation: 12, climbing: 8, acrobatics: 8, bartering: 5, brawling: 3, justice: 8 } },
  { id: 'battle-medic', name: 'Battle Medic', description: 'High Mana healer. Keeps Mercy reputation high.', icon: '💉', offense: 30, defense: 50, magic: 80, primaryStrength: 'Regeneration/Persuasion', majorWeakness: 'Low offense', category: 'high_magic', tier: 'professional', maxMana: 150, maxStamina: 60, startingSkills: ['Regeneration', 'Persuasion'], defaultStats: { regeneration: 25, persuasion: 18, alteration: 12, investigation: 8, mercy: 20, honor: 10, loyalty: 10, brawling: 2, stealth: 1 } },
  { id: 'shadow-blade', name: 'Shadow Blade', description: 'Ultimate assassin for Cold Justice playthroughs.', icon: '🌑', offense: 90, defense: 30, magic: 40, primaryStrength: 'Stealth/Sleight of Hand', majorWeakness: 'Very Low HP', category: 'low_magic', tier: 'professional', maxMana: 15, maxStamina: 175, startingSkills: ['Stealth', 'Sleight of Hand'], defaultStats: { stealth: 25, sleight_of_hand: 20, one_handed: 15, acrobatics: 12, climbing: 10, aim: 5, illusion: 5, infamy: 8 } },
  { id: 'wandering-knight', name: 'Wandering Knight', description: 'High Physical Defense. Honorable warrior.', icon: '🛡️', offense: 70, defense: 90, magic: 20, primaryStrength: 'Two Handed/Honor', majorWeakness: 'Slow Movement', category: 'low_magic', tier: 'professional', maxMana: 15, maxStamina: 160, startingSkills: ['Two Handed', 'Honor'], defaultStats: { two_handed: 22, one_handed: 12, brawling: 8, climbing: 5, persuasion: 5, honor: 20, bravery: 15, loyalty: 10, justice: 8 } },

  // === Specialized/Hybrid Classes ===
  { id: 'soul-binder', name: 'Soul Binder', description: 'Can bind defeated enemies as permanent companions.', icon: '🔮', offense: 50, defense: 50, magic: 80, primaryStrength: 'Soulbinding/Loyalty', majorWeakness: 'Low physical stats', category: 'high_magic', tier: 'hybrid_specialized', maxMana: 160, maxStamina: 55, startingSkills: ['Soulbinding', 'Loyalty'], defaultStats: { soulbinding: 25, necromancy: 12, alteration: 12, persuasion: 10, investigation: 8, loyalty: 20, bravery: 5, brawling: 2, stealth: 2 } },
  { id: 'gunsmith', name: 'Gunsmith/Alchemist', description: 'Uses Bloodmancy to craft custom bullets.', icon: '🔧', offense: 70, defense: 40, magic: 50, primaryStrength: 'Aim/Bartering', majorWeakness: 'Relies on crafted ammo', category: 'hybrid', tier: 'hybrid_specialized', maxMana: 60, maxStamina: 100, startingSkills: ['Aim', 'Bartering'], defaultStats: { aim: 22, bartering: 18, bloodmancy: 10, investigation: 10, sleight_of_hand: 8, destruction: 5, stealth: 5, climbing: 3 } },
  { id: 'illusionist', name: 'Illusionist Thief', description: 'Decoy costs 0 Mana but 20 Stamina.', icon: '🎭', offense: 50, defense: 30, magic: 70, primaryStrength: 'Illusion/Deception', majorWeakness: 'Low direct damage', category: 'hybrid', tier: 'hybrid_specialized', maxMana: 75, maxStamina: 85, startingSkills: ['Illusion', 'Deception'], defaultStats: { illusion: 25, stealth: 15, sleight_of_hand: 15, persuasion: 10, acrobatics: 8, seduction: 5, bartering: 5, brawling: 1 } },
  { id: 'void-walker', name: 'Void Walker', description: 'Can Phase through attacks, regains Stamina on success.', icon: '🌀', offense: 60, defense: 40, magic: 70, primaryStrength: 'Alteration/Acrobatics', majorWeakness: 'Unstable abilities', category: 'hybrid', tier: 'hybrid_specialized', maxMana: 80, maxStamina: 80, startingSkills: ['Alteration', 'Acrobatics'], defaultStats: { alteration: 22, acrobatics: 18, destruction: 10, stealth: 8, climbing: 8, illusion: 8, investigation: 5, bravery: 8 } },
  { id: 'dread-lord', name: 'Dread Lord', description: 'Villain path. Necromancy and area damage.', icon: '👑', offense: 80, defense: 50, magic: 80, primaryStrength: 'Necromancy/Intimidation', majorWeakness: 'Hated by all NPCs', category: 'high_magic', tier: 'hybrid_specialized', maxMana: 170, maxStamina: 50, startingSkills: ['Necromancy', 'Intimidation'], defaultStats: { necromancy: 22, intimidation: 20, destruction: 15, soulbinding: 10, bloodmancy: 8, infamy: 25, malice: 20, brawling: 3 } },

  // === Original Classes (remapped) ===
  { id: 'assassin', name: 'Assassin', description: 'Master of shadows and critical strikes', icon: '🗡️', offense: 100, defense: 20, magic: 20, primaryStrength: 'Stealth/Crit Damage', majorWeakness: 'Very Low HP', category: 'low_magic', tier: 'professional', maxMana: 10, maxStamina: 190, startingSkills: ['Stealth', 'One Handed'], defaultStats: { stealth: 25, one_handed: 20, acrobatics: 15, sleight_of_hand: 12, climbing: 8, aim: 5, infamy: 10, bravery: 5 } },
  { id: 'brute', name: 'Brute', description: 'Unstoppable wall of muscle', icon: '💪', offense: 70, defense: 100, magic: 10, primaryStrength: 'Raw HP/Physical Def', majorWeakness: 'Extremely Slow', category: 'low_magic', tier: 'professional', maxMana: 10, maxStamina: 200, startingSkills: ['Brawling', 'Two Handed'], defaultStats: { brawling: 25, two_handed: 20, climbing: 10, intimidation: 12, bravery: 15, one_handed: 5, acrobatics: 2 } },
  { id: 'priest', name: 'Priest', description: 'Divine healer and protector', icon: '⛪', offense: 10, defense: 50, magic: 100, primaryStrength: 'Healing/Shields', majorWeakness: 'Zero Physical Attack', category: 'high_magic', tier: 'professional', maxMana: 200, maxStamina: 40, startingSkills: ['Regeneration', 'Alteration'], defaultStats: { regeneration: 25, alteration: 22, persuasion: 15, mercy: 25, honor: 15, loyalty: 10, investigation: 5, brawling: 1 } },
  { id: 'storm-mage', name: 'Storm Mage', description: 'Master of lightning and wind', icon: '⚡', offense: 90, defense: 30, magic: 90, primaryStrength: 'High AoE Damage', majorWeakness: 'High Mana Cost', category: 'high_magic', tier: 'exotic', maxMana: 180, maxStamina: 45, startingSkills: ['Destruction', 'Alteration'], defaultStats: { destruction: 25, alteration: 18, illusion: 8, regeneration: 5, intimidation: 8, bravery: 10, brawling: 2, climbing: 2 } },
  { id: 'bard', name: 'Bard', description: 'Charismatic performer and buffer', icon: '🎵', offense: 40, defense: 40, magic: 70, primaryStrength: 'Buffing/Persuasion', majorWeakness: 'Weak Solo Fighter', category: 'hybrid', tier: 'professional', maxMana: 70, maxStamina: 85, startingSkills: ['Persuasion', 'Illusion'], defaultStats: { persuasion: 25, illusion: 18, seduction: 12, bartering: 10, investigation: 8, acrobatics: 5, alteration: 5, loyalty: 8 } },
  { id: 'druid', name: 'Druid', description: 'Guardian of nature', icon: '🌿', offense: 50, defense: 60, magic: 80, primaryStrength: 'Shapeshifting/Nature Magic', majorWeakness: 'Weak in Cities', category: 'hybrid', tier: 'professional', maxMana: 80, maxStamina: 80, startingSkills: ['Beastmastery', 'Regeneration'], defaultStats: { beastmastery: 25, regeneration: 18, alteration: 12, climbing: 10, investigation: 8, mercy: 10, honor: 5, brawling: 5 } },
  { id: 'monk', name: 'Monk', description: 'Martial arts master', icon: '🥋', offense: 70, defense: 70, magic: 40, primaryStrength: 'Unarmed Combat/Speed', majorWeakness: 'No Armor', category: 'hybrid', tier: 'professional', maxMana: 60, maxStamina: 100, startingSkills: ['Brawling', 'Acrobatics'], defaultStats: { brawling: 22, acrobatics: 20, climbing: 12, stealth: 8, regeneration: 8, honor: 10, bravery: 10, persuasion: 3 } },
  { id: 'pyromancer', name: 'Pyromancer', description: 'Master of flames', icon: '🔥', offense: 100, defense: 20, magic: 80, primaryStrength: 'Fire Damage/AoE', majorWeakness: 'Self-Damage Risk', category: 'high_magic', tier: 'exotic', maxMana: 160, maxStamina: 50, startingSkills: ['Destruction', 'Bloodmancy'], defaultStats: { destruction: 25, bloodmancy: 18, alteration: 8, intimidation: 10, bravery: 12, acrobatics: 3, stealth: 2, infamy: 5 } },
  { id: 'rogue', name: 'Rogue', description: 'Cunning thief and trickster', icon: '🎪', offense: 70, defense: 40, magic: 30, primaryStrength: 'Stealth/Lockpicking', majorWeakness: 'Low Direct Combat', category: 'low_magic', tier: 'professional', maxMana: 15, maxStamina: 165, startingSkills: ['Stealth', 'Sleight of Hand'], defaultStats: { stealth: 22, sleight_of_hand: 20, acrobatics: 12, bartering: 10, climbing: 8, one_handed: 8, investigation: 5, infamy: 5 } },
  { id: 'archer', name: 'Archer', description: 'Precision ranged fighter', icon: '🏹', offense: 80, defense: 30, magic: 30, primaryStrength: 'Ranged Attacks/Accuracy', majorWeakness: 'Weak in Melee', category: 'low_magic', tier: 'professional', maxMana: 15, maxStamina: 165, startingSkills: ['Aim', 'Acrobatics'], defaultStats: { aim: 25, acrobatics: 15, stealth: 10, climbing: 10, investigation: 8, bravery: 8, one_handed: 3, beastmastery: 5 } },
  { id: 'necromancer', name: 'Necromancer', description: 'Commander of the undead', icon: '☠️', offense: 50, defense: 30, magic: 100, primaryStrength: 'Summon Undead/Curses', majorWeakness: 'Hated by All', category: 'high_magic', tier: 'exotic', maxMana: 190, maxStamina: 40, startingSkills: ['Necromancy', 'Soulbinding'], defaultStats: { necromancy: 25, soulbinding: 20, destruction: 10, bloodmancy: 8, intimidation: 10, infamy: 20, malice: 10, investigation: 3 } },
  { id: 'paladin', name: 'Paladin', description: 'Holy knight of justice', icon: '⚔️', offense: 70, defense: 80, magic: 50, primaryStrength: 'Holy Damage/Healing', majorWeakness: 'Cannot Lie/Deceive', category: 'hybrid', tier: 'professional', maxMana: 70, maxStamina: 90, startingSkills: ['Two Handed', 'Regeneration'], defaultStats: { two_handed: 18, regeneration: 15, one_handed: 10, persuasion: 8, honor: 20, justice: 15, bravery: 12, loyalty: 10, mercy: 8 } },
  { id: 'berserker', name: 'Berserker', description: 'Rage-fueled warrior', icon: '🪓', offense: 100, defense: 30, magic: 00, primaryStrength: 'Extreme Damage/Rage Mode', majorWeakness: 'Cannot Defend', category: 'low_magic', tier: 'professional', maxMana: 10, maxStamina: 200, startingSkills: ['Brawling', 'Two Handed'], defaultStats: { brawling: 25, two_handed: 22, climbing: 8, intimidation: 15, bravery: 20, infamy: 5, acrobatics: 3 } },
  { id: 'knight', name: 'Knight', description: 'Honorable armored warrior', icon: '🏰', offense: 60, defense: 90, magic: 20, primaryStrength: 'Heavy Armor/Leadership', majorWeakness: 'Slow Movement', category: 'low_magic', tier: 'professional', maxMana: 15, maxStamina: 160, startingSkills: ['Two Handed', 'One Handed'], defaultStats: { two_handed: 18, one_handed: 15, brawling: 8, persuasion: 8, honor: 18, loyalty: 12, bravery: 15, justice: 8 } },

  // === Final Challenge Classes ===
  { id: 'fallen-hero', name: 'The Fallen Hero', description: 'Balanced but starts with permanent Drained debuff until Level 5.', icon: '⬇️', offense: 50, defense: 50, magic: 50, primaryStrength: 'Balanced stats', majorWeakness: 'Permanent Stage 1 Drained until Lv5', category: 'hybrid', tier: 'final_challenge', maxMana: 70, maxStamina: 90, startingSkills: ['One Handed', 'Persuasion'], defaultStats: { one_handed: 10, persuasion: 10, brawling: 8, stealth: 8, destruction: 8, alteration: 8, acrobatics: 8, honor: 5, bravery: 5 } },
  { id: 'cursed-peasant', name: 'Cursed Peasant', description: 'Starts at +0 everything. Every kill grants 2x XP.', icon: '🧑‍🌾', offense: 20, defense: 20, magic: 20, primaryStrength: '2x XP on kills', majorWeakness: 'Zero starting stats', category: 'hybrid', tier: 'final_challenge', maxMana: 40, maxStamina: 80, startingSkills: [], defaultStats: {} },
  { id: 'broken-vessel', name: 'The Broken Vessel', description: '0 Max Mana. Uses Bloodmancy (HP/Stamina) for all spells.', icon: '💔', offense: 70, defense: 50, magic: 30, primaryStrength: 'Bloodmancy casting without mana', majorWeakness: '0 Mana, permanent Shaking', category: 'low_magic', tier: 'final_challenge', maxMana: 0, maxStamina: 150, startingSkills: ['Brawling', 'Regeneration', 'Bravery'], defaultStats: { brawling: 18, regeneration: 15, bloodmancy: 12, climbing: 8, two_handed: 8, bravery: 20, intimidation: 5 } },
  { id: 'nameless-ghoul', name: 'The Nameless Ghoul', description: 'Reputation locked at -50. Soulbinding/Necromancy costs halved.', icon: '👻', offense: 60, defense: 40, magic: 70, primaryStrength: 'Half-cost Necromancy, consume enemies for Stamina', majorWeakness: 'NPCs refuse to speak to you', category: 'high_magic', tier: 'final_challenge', maxMana: 140, maxStamina: 60, startingSkills: ['Stealth', 'Necromancy', 'Sleight of Hand'], defaultStats: { necromancy: 20, stealth: 18, sleight_of_hand: 15, soulbinding: 10, bloodmancy: 8, infamy: 15, malice: 15, investigation: 3 } },
  { id: 'fallen-prodigy', name: 'The Fallen Prodigy', description: 'Lost their eyes. Ranged/Aim capped at 0. Massive Illusion radius.', icon: '🔮', offense: 40, defense: 30, magic: 90, primaryStrength: '100% Investigation success, huge spell radius', majorWeakness: 'Cannot use Ranged/Aim ever', category: 'high_magic', tier: 'final_challenge', maxMana: 180, maxStamina: 45, startingSkills: ['Illusion', 'Alteration', 'Investigation'], defaultStats: { illusion: 25, alteration: 20, investigation: 20, destruction: 10, regeneration: 8, persuasion: 5, bravery: 8 } },
  { id: 'exile-kingslayer', name: 'The Exile Kingslayer', description: 'Hunted by Bounty Hunters. x3 Vengeance Strike on defense.', icon: '👑', offense: 80, defense: 100, magic: 20, primaryStrength: 'Highest defense, 2x Stamina on defending High attacks', majorWeakness: 'Random bounty hunter ambushes', category: 'low_magic', tier: 'final_challenge', maxMana: 15, maxStamina: 180, startingSkills: ['Two Handed', 'Intimidation', 'Justice'], defaultStats: { two_handed: 22, intimidation: 18, brawling: 12, climbing: 8, one_handed: 8, justice: 20, bravery: 15, infamy: 10 } },
  { id: 'mimic-symbiote', name: 'The Mimic Symbiote', description: 'Bonded with a parasite. Can copy enemy skills. Regen drains Stamina.', icon: '🦠', offense: 60, defense: 50, magic: 60, primaryStrength: 'Copy one Active Skill from defeated enemies', majorWeakness: 'Regen drains Stamina each turn; 0 Stamina = HP drain', category: 'hybrid', tier: 'final_challenge', maxMana: 70, maxStamina: 90, startingSkills: ['Acrobatics', 'Deception', 'Alteration'], defaultStats: { acrobatics: 18, alteration: 15, stealth: 12, climbing: 8, brawling: 8, investigation: 8, sleight_of_hand: 5, bravery: 5 } },
];
...
export interface Character {
  ...
  user_id: string;
  name: string;
  description: string | null; // Physical appearance description
  hp: number;
  max_hp: number;
  gold: number;
